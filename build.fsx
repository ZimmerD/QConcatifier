...
let project = "QConcatifier"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "This project offers an automated processing pipeline for Quantification of QConcat peptides."
...
let tags = "Qconcat Proteomics shotgun F# FSharp mass spec"

// File system information
let solutionFile  = "QConcatifier.sln"
...
let info =
  [ "project-name", "QConcatifier"
    "project-author", "David Zimmer"
    "project-summary", "This project offers an automated processing pipeline for Quantification of QConcat peptides."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/QConcatifier" ]
